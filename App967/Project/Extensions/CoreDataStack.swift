...
class CoreDataStack {
    ...
    func deleteStat(withStTotSub name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<StatModel> = StatModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "stTotSub == %@", name)
    ...
    func deleteTask(withTaName name: String, completion: @escaping () -> Void) {

        let context = CoreDataStack.shared.persistentContainer.viewContext
        let fetchRequest: NSFetchRequest<TaskModel> = TaskModel.fetchRequest()

        fetchRequest.predicate = NSPredicate(format: "tsName == %@", name)
